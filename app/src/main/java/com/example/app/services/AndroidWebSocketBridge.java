...
import android.webkit.WebView;
import android.util.Log;
// Import your controller package path
import com.example.app.services.livewire.LivewireBridgeController; 
...
public class AndroidWebSocketBridge {
    ...
    public AndroidWebSocketBridge(Context context, WebView webView) {
        ...
        // CRITICAL FIX: Pass the active UI WebView object reference straight 
        // into the Livewire Bridge Controller's static global fallback instance.
        LivewireBridgeController.globalWebViewFallbackInstance = webView;
        Log.d(TAG, "✅ Successfully registered active WebView handle into Livewire global fallback pool.");
